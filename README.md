...
**Bagian 6 - Kode Etik Profesi**

Kasus Air Canada Chatbot Hallucination menunjukkan bahwa penggunaan Artificial Intelligence (AI) dalam pelayanan pelanggan tidak hanya berkaitan dengan aspek teknologi, tetapi juga dengan tanggung jawab profesional dalam mengembangkan dan mengoperasikan sistem tersebut. Oleh karena itu, analisis kasus ini menggunakan ACM Code of Ethics and Professional Conduct sebagai acuan kode etik profesi di bidang komputasi. Selain itu, jurnal *Etika dan Pertanggungjawaban Penggunaan Artificial Intelligence di Indonesia* digunakan sebagai landasan teori untuk menjelaskan prinsip-prinsip etika dalam penerapan AI yang bertanggung jawab.[7]

1.  **ACM Principle 1.2: Avoid Harm (Menghindari Kerugian)**

> Prinsip **Avoid Harm** menyatakan bahwa setiap profesional di bidang komputasi harus menghindari tindakan yang dapat menimbulkan kerugian bagi pengguna, baik kerugian materiil maupun nonmateriil. Dalam pengembangan sistem AI, pengembang memiliki tanggung jawab untuk memastikan bahwa informasi yang dihasilkan sistem tidak menyesatkan dan tidak merugikan masyarakat.
>
> Pada kasus Air Canada, chatbot memberikan informasi yang tidak sesuai dengan kebijakan resmi mengenai **bereavement fare**, sehingga pelanggan membeli tiket berdasarkan informasi tersebut dan mengalami kerugian ketika permohonan pengembalian dana ditolak. Walaupun kesalahan berasal dari chatbot, dampak yang ditimbulkan tetap menjadi tanggung jawab organisasi karena AI merupakan bagian dari layanan perusahaan.
>
> Hal tersebut sejalan dengan konsep akuntabilitas dalam jurnal yang menyatakan bahwa tanggung jawab AI tidak hanya berada pada sistem, tetapi juga pada seluruh pihak yang terlibat dalam desain, pengembangan, implementasi, dan penggunaannya (*multi-stakeholder responsibility*). Oleh karena itu, perusahaan tidak dapat mengalihkan tanggung jawab kepada chatbot sebagai alasan atas kesalahan informasi yang diberikan.[7]

2.  **ACM Principle 2.5: Give Comprehensive and Thorough Evaluations of Computer Systems**

> Prinsip ini menekankan bahwa setiap sistem komputasi harus melalui proses evaluasi, pengujian, dan validasi secara menyeluruh sebelum digunakan oleh masyarakat. Tujuannya adalah untuk memastikan bahwa sistem mampu memberikan hasil yang benar, konsisten, dan sesuai dengan tujuan penggunaannya.
>
> Dalam kasus Air Canada, chatbot menghasilkan jawaban yang berbeda dengan kebijakan resmi perusahaan. Hal ini menunjukkan bahwa proses evaluasi terhadap basis pengetahuan (*knowledge base*) maupun mekanisme validasi jawaban belum dilakukan secara optimal. Akibatnya, chatbot menyampaikan informasi yang tidak akurat kepada pelanggan.
>
> Jurnal *Etika dan Pertanggungjawaban Penggunaan Artificial Intelligence di Indonesia* juga menegaskan bahwa penerapan AI yang bertanggung jawab memerlukan proses evaluasi yang berkelanjutan, termasuk pengujian terhadap kemungkinan kesalahan sistem sebelum AI digunakan secara luas. Dengan demikian, perusahaan seharusnya melakukan pembaruan dan pengawasan secara berkala agar informasi yang diberikan chatbot selalu sesuai dengan kebijakan yang berlaku.[7]

3.  **ACM Principle 3.1: Ensure That the Public Good Is the Central Concern**

> Prinsip ini menegaskan bahwa kepentingan masyarakat harus menjadi prioritas utama dalam setiap pengembangan dan penggunaan teknologi. Penerapan AI seharusnya tidak hanya berorientasi pada efisiensi atau keuntungan perusahaan, tetapi juga harus menjamin keamanan, keakuratan informasi, dan perlindungan terhadap pengguna.
>
> Pada kasus Air Canada, penggunaan chatbot memang membantu mempercepat pelayanan pelanggan. Namun, kesalahan informasi yang diberikan menunjukkan bahwa perusahaan belum sepenuhnya mengutamakan kepentingan konsumen. Informasi yang tidak akurat menyebabkan pelanggan mengambil keputusan yang merugikan dirinya.
>
> Berdasarkan jurnal *Etika dan Pertanggungjawaban Penggunaan Artificial Intelligence di Indonesia*, penerapan Artificial Intelligence yang bertanggung jawab harus didasarkan pada prinsip transparansi, akuntabilitas, keadilan, serta keamanan dan privasi. Keempat prinsip tersebut perlu diterapkan pada seluruh proses pengembangan dan penggunaan AI agar teknologi dapat memberikan manfaat bagi masyarakat sekaligus meminimalkan risiko kerugian. Prinsip ini sejalan dengan ACM Code of Ethics yang menempatkan kepentingan publik sebagai prioritas utama dalam praktik profesi komputasi.[7]

Berdasarkan **ACM Code of Ethics and Professional Conduct**, Air Canada telah melanggar Principle 1.2 (Avoid Harm), Principle 2.5 (Give Comprehensive and Thorough Evaluations of Computer Systems), dan Principle 3.1 (Ensure That the Public Good Is the Central Concern). Ketiga prinsip tersebut menunjukkan bahwa organisasi tetap bertanggung jawab atas seluruh informasi yang diberikan sistem AI, sehingga perusahaan wajib memastikan sistem bekerja secara akurat, aman, dan tidak merugikan pengguna.
...
**Pasal 2 ayat (1) UU Tipikor (No. 31/1999)**: “Setiap orang yang secara melawan hukum melakukan perbuatan memperkaya diri sendiri atau orang lain atau suatu korporasi yang merugikan keuangan negara atau perekonomian negara, dipidana dengan pidana penjara paling singkat 4 tahun dan paling lama 20 tahun.”

**Pasal 3 UU Tipikor tentang penyalahgunaan wewenang**: “Korupsi adalah perbuatan dengan tujuan menguntungkan diri sendiri atau orang lain atau suatu korporasi, menyalahgunakan kewenangan, kesempatan, atau sarana yang ada padanya karena jabatan atau kedudukannya yang dapat merugikan keuangan negara atau perekonomian negara.”

### **Checkpoint spesifik dalam konteks AI**

1.  Penyalahgunaan Kewenangan/Kepercayaan. Pejabat yang secara sadar membiarkan chatbot negara menyebarkan informasi keliru untuk menghalau klaim sah dari warga misalnya informasi subsidi, layanan kesehatan, atau beasiswa dapat memenuhi unsur Pasal 3 Tipikor.

2.  Penyembunyian Informasi. Jika operator chatbot mengetahui terdapat hallucination sistemik namun tidak mengambil tindakan perbaikan dan tidak mengungkapkannya, ini melanggar Pasal 28 ayat (1) UU ITE tentang penyebaran informasi yang menimbulkan kerugian konsumen.

3.  Konflik Kepentingan. Penggunaan fasilitas atau sistem yang diberikan tanpa imbalan jelas, terutama jika tidak ada biaya sewa yang dibayar untuk penggunaan sistem AI komersial tertentu, dapat menimbulkan pertanyaan apakah pemberian fasilitas tersebut dimaksudkan untuk memberikan keuntungan pribadi atau kepentingan politik tertentu. Pengadaan chatbot yang menguntungkan vendor tertentu tanpa proses transparan berpotensi melanggar Pasal 12B Tipikor tentang gratifikasi.

4.  Kerugian Publik Sistemik. Berbeda dengan kasus Air Canada yang berdampak individual (CAD $812), chatbot instansi pemerintah dapat merugikan ribuan warga secara serentak, sehingga potensi kerugian negara menjadi jauh lebih masif.

Konstruksi hukum yang berlaku, terutama Pasal 3 UU Tipikor dan UU Administrasi Pemerintahan, memberikan jangkauan yang luas bagi aparat penegak hukum mencakup pejabat publik, direksi BUMN, hingga korporasi swasta yang bermitra dengan pemerintah

**Kesenjangan Regulasi dan Rekomendasi Awal**

AI hallucination rates remain dangerously high even controlled chatbot environments experience hallucination rates of 3% to 27%, making governance essential for customer-facing interactions. Dalam konteks Indonesia, hal ini semakin kritis mengingat:

- Belum adanya lembaga DPA (Data Protection Authority) yang independen sebagaimana diamanatkan UU PDP;

- Belum ada UU AI khusus Indonesia sedang menyusun roadmap nasional AI dengan target 2026;

- Penegakan hukum terhadap PSE asing masih lemah karena yurisdiksi lintas batas.

Rekomendasi kebijakan berdasarkan preseden Moffatt v. Air Canada:

- PSE yang mengoperasikan chatbot wajib menerapkan audit AI berkala dan mekanisme drift detection;

- Transparansi algoritmik harus diwajibkan untuk layanan publik dan konsumen;

- Klausa pengecualian tanggung jawab dalam ToS tidak dapat membebaskan PSE dari kewajiban duty of care;

- Dibentuk mekanisme pengaduan berbasis bukti mengikuti preseden screenshot Moffatt yang menjadi alat bukti kunci.

**Evaluasi Kepatuhan terhadap Regulasi Hukum, HKI, dan Standar Industri**

1.  **Kepatuhan Regulasi Hukum**

| **Aspek**                      | **Status kepatuhan (analogi kasus)**                                     | **Dasar hukum**                                 |
|:-------------------------------|:-------------------------------------------------------------------------|:------------------------------------------------|
| Akuntabilitas PSE              | Berpotensi tidak patuh chatbot dianggap “entitas terpisah” oleh operator | Pasal 21 UU ITE                                 |
| Akurasi data/informasi         | Tidak patuh chatbot memberikan informasi menyesatkan tanpa verifikasi    | UU PDP Pasal 20 (akuntabilitas pengendali data) |
| Transparansi AI                | Belum ada kewajiban formal di Indonesia, namun direkomendasikan          | SE Kemenkominfo No. 9/2023                      |
| Mekanisme keluhan & ganti rugi | Belum ada SOP standar bagi banyak PSE Indonesia                          | PP PSTE Pasal 29, 31                            |

2.  **Kepatuhan HKI (Hak Kekayaan Intelektual)**

> Isu HKI dalam konteks chatbot AI di Indonesia memiliki dua dimensi:

- **Konten yang dihasilkan chatbot**

> Pasal 1 angka 2 UU Hak Cipta menyatakan bahwa pencipta adalah seorang atau beberapa orang yang secara sendiri-sendiri atau bersama-sama menghasilkan suatu ciptaan yang bersifat khas dan pribadi konsep pencipta dalam hukum Indonesia masih melekat pada manusia. Konsekuensinya, output chatbot (termasuk yang keliru/halusinasi) tidak memiliki status hak cipta yang jelas, namun perusahaan tetap bertanggung jawab penuh atas kontennya sebagai produk layanan, bukan sebagai “karya independen AI”.

### **Data latih (training data)**

> Penggunaan karya seni sebagai dataset untuk AI Generatif menimbulkan persoalan hukum tersendiri terkait HKI yang ada saat ini. Jika chatbot dilatih menggunakan materi berhak cipta (misalnya kebijakan kompetitor, basis pengetahuan pihak ketiga) tanpa lisensi, ini berpotensi melanggar UU No. 28/2014 tentang Hak Cipta.
>
> Hasil penelitian menunjukkan bahwa norma yang berlaku belum mengatur secara jelas status hukum karya AI, termasuk mengenai penentuan pencipta, standar orisinalitas, atribusi kepemilikan, legalitas penggunaan data latih berhak cipta, dan mekanisme penegakan hukum digital lintas yurisdiksi. Ini merupakan gap kepatuhan struktural yang berlaku umum di Indonesia, bukan spesifik pada satu perusahaan.

3.  **Kepatuhan Standar Industri**

> Pada Desember 2023, ISO dan IEC merilis ISO/IEC 42001:2023, sistem manajemen AI pertama di dunia bukan sekadar panduan teknis, melainkan standar manajemen yang menjadi kompas global untuk memastikan AI dikembangkan, digunakan, dan diawasi dengan cara yang transparan, adil, dan dapat dipercaya.
>
> Contoh penerapan nyata di Indonesia: BCA meraih sertifikasi ISO/IEC 42001:2023 sebagai bank pertama di Asia Tenggara standar global yang mengatur sistem manajemen AI, mencakup aspek tata kelola, manajemen risiko, transparansi, serta akuntabilitas penggunaan AI, yang semakin relevan seiring meningkatnya pemanfaatan AI dalam layanan nasabah.
>
> Lima standar SNI ISO/IEC untuk tata kelola AI dapat dipetakan sebagai satu rantai: sistem manajemen (42001), penilaian dampak (42005), transparansi (12792), penanganan bias (12791), hingga audit dan sertifikasi (42006). Operator chatbot seperti Air Canada, jika beroperasi di Indonesia dan mengacu pada kerangka ini, gagal pada level paling dasar: tidak ada sistem manajemen AI terdokumentasi, tidak ada penilaian dampak sebelum peluncuran chatbot.
>
> Kesimpulan kepatuhan: kasus Air Canada bila terjadi di Indonesia akan menunjukkan ketidakpatuhan pada tiga lapis sekaligus: regulasi hukum (UU ITE/PDP), standar industri (ISO 42001 belum diadopsi), dan tata kelola sektoral (belum ada Komite AI internal). Bentuk Komite AI (AI Committee) yang terdiri dari fungsi risiko, hukum, TI, data, dan kepatuhan menjadi praktik yang direkomendasikan namun belum wajib secara hukum di Indonesia.
>
> **Evaluasi Risiko Etis dengan Kerangka Analisis Risiko (ISO 31000)**
>
> ISO 31000:2018 mendefinisikan prinsip dan pendekatan sistematis untuk mengelola berbagai jenis risiko dalam organisasi meskipun tidak secara eksklusif berfokus pada AI, standar ini berfungsi sebagai dasar untuk menyusun tata kelola risiko teknologi yang kuat, termasuk risiko yang timbul dari algoritma dan otomatisasi
>
> **Proses ISO 31000 diterapkan pada kasus chatbot**

1.  **Identifikasi risiko (risk identification)**

> Empat risiko utama teridentifikasi dari kasus Air Canada dan konteks Indonesia: (R1) halusinasi informasi yang merugikan konsumen, (R2) kebocoran/penyalahgunaan data pribadi, (R3) bias atau diskriminasi algoritmik, (R4) pelanggaran HKI dalam data latih atau output.

| **Kode** | **Deskripsi risiko**                               | **Likelihood** | **Dampak**    |
|:---------|:---------------------------------------------------|:---------------|:--------------|
| **R1**   | Halusinasi informasi (mis. tarif/kebijakan keliru) | Tinggi         | Tinggi        |
| **R2**   | Kebocoran/penyalahgunaan data pribadi pengguna     | Sedang         | Sangat tinggi |
| **R3**   | Bias/diskriminasi algoritmik dalam respons         | Sedang         | Tinggi        |
| **R4**   | Pelanggaran HKI (konten/dataset latih)             | Rendah         | Sedang        |

2.  **Analisis risiko (risk analysis)**

> R1 (halusinasi) memiliki likelihood tinggi karena hallucination rates pada lingkungan chatbot terkontrol berkisar 3% hingga 27% bukan kejadian langka, melainkan karakteristik bawaan teknologi generative AI. Dampaknya tinggi karena menyentuh langsung kepercayaan dan hak finansial konsumen, seperti terlihat pada kasus Moffatt.
>
> R2 (kebocoran data) memiliki dampak sangat tinggi karena menyangkut hak asasi privasi yang dilindungi UU PDP, meski likelihood-nya lebih rendah dibanding R1 jika kontrol akses data memadai.

3.  **Evaluasi risiko (risk evaluation)**

> Dengan pendekatan ISO 31000, R1 dan R2 berada pada zona risiko tinggi hingga ekstrem memerlukan tindakan mitigasi segera dan tidak dapat diterima (unacceptable) tanpa kontrol tambahan. R3 berada pada zona tinggi karena berpotensi melanggar prinsip non-diskriminasi yang ditekankan SE Kominfo. R4 berada pada zona sedang, dapat dikelola melalui kontrak lisensi data yang lebih baik.

4.  **Konteks risiko etis vs. legal**

> Kasus ini memiliki signifikansi hukum sekaligus moral tantangan terkait responsibility gap muncul karena kesulitan mengatribusikan tanggung jawab dalam konteks AI yang melibatkan “banyak tangan”, yaitu banyak pihak yang terlibat dalam pengembangan perangkat lunak dan implementasinya. Inilah dimensi etis yang melampaui kepatuhan hukum semata risiko reputasi dan kepercayaan publik tidak selalu tertangkap oleh kerangka hukum positif.

**Perumusan Strategi Mitigasi Risiko Etika & Kontrol Preventif**

Berdasarkan prinsip ISO 31000 integrasi risiko ke dalam proses organisasi, pendekatan terstruktur dan komprehensif, kustomisasi terhadap konteks organisasi, sifat dinamis yang berkembang seiring perubahan kondisi, dan perbaikan berkelanjutan, berikut strategi mitigasi yang disusun per tingkat risiko.

1.  **Kontrol Preventif untuk R1 (Halusinasi Informasi)**

- Human-in-the-loop verification: setiap klaim finansial/kebijakan dari chatbot harus tertaut langsung (bukan hanya hyperlink terpisah) ke sumber kebijakan resmi yang sama, mengikuti pelajaran dari kasus Moffatt di mana tribunal menyatakan tidak masuk akal mengharuskan konsumen mengecek silang antar halaman situs yang sama.

- Drift detection & incident logging: pemantauan otomatis untuk mendeteksi kesenjangan yang berkembang antara respons AI dan kebijakan terkini, serta dokumentasi seluruh kesalahan chatbot untuk analisis pola dan koreksi.

- Disclaimer yang tidak melepaskan tanggung jawab hukum: ToS dapat menjelaskan keterbatasan AI, tetapi sebagaimana ditegaskan tribunal Kanada, klausul tersebut tidak menghapus duty of care terhadap konsumen

2.  **Kontrol Preventif untuk R2 (Data Pribadi)**

- Penerapan Data Protection Impact Assessment (DPIA) sebelum peluncuran chatbot, sejalan dengan prinsip privacy by design dalam UU PDP.

- Sertifikasi ISO 27701 (Privacy Information Management) sebagaimana telah diadopsi BCA, dipasangkan dengan ISO 42001 untuk tata kelola AI menyeluruh.

3.  **Kontrol Preventif untuk R3 (Bias Algoritmik)**

- Penerapan SNI ISO/IEC 12791 untuk penanganan bias, memastikan tidak ada “akses khusus” yang merugikan kelompok tertentu dalam respons chatbot.

- Audit berkala terhadap respons chatbot lintas demografi pengguna.

4.  **Kontrol Preventif untuk R4 (HKI)**

- Due diligence terhadap sumber data latih, memastikan lisensi yang sah atas seluruh korpus pengetahuan chatbot.

- Dokumentasi rantai kepemilikan (provenance) data untuk setiap pembaruan basis pengetahuan AI.

5.  **Kontrol Struktural Lintas-Risiko**

- Pembentukan Komite AI lintas fungsi (hukum, risiko, TI, kepatuhan) memastikan arah strategis AI sejalan dengan visi bisnis dan tanggung jawab manajemen, melindungi organisasi dari ancaman bias, pelanggaran data, dan kesalahan algoritma.

- Sertifikasi ISO/IEC 42001 sebagai kerangka manajemen menyeluruh, diselaraskan dengan NIST AI Risk Management Framework untuk pengelolaan risiko dan prinsip trustworthiness, COBIT 2019 untuk tata kelola teknologi, serta panduan AI OJK untuk sektor perbankan (bila relevan).

- Mekanisme pengaduan berbasis bukti digital mengikuti preseden screenshot yang menjadi bukti kunci dalam kasus Moffatt, organisasi perlu memastikan log percakapan chatbot tersimpan dan dapat diakses pengguna sebagai bukti.
...
[7] N. Nasman, P. Astuti, dan D. Perwitasari, “Etika dan Pertanggungjawaban Penggunaan Artificial Intelligence di Indonesia,” *Rewang Rencang: Jurnal Hukum Lex Generalis*, vol. 5, no. 10, 2024.
